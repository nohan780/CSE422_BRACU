...
yPrediction_list = yPrediction.tolist()

reg = (metrics.mean_squared_error(y_test_list , yPrediction_list))

y_avg = mean(y_test_list)
y_avg = [y_avg] * len(y_test_list)
total = (metrics.mean_squared_error(y_test_list , y_avg))
print(1 - (reg/total))